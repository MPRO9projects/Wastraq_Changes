  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.wq-chat-launcher{',
        ...
        'background:linear-gradient(135deg,#16a34a,#14502e);',
        'border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;',
        'box-shadow:0 4px 20px rgba(22,101,52,.4);',
        'transition:transform .2s,box-shadow .2s;',
        'outline:none;',
      '}',
      '.wq-chat-launcher:hover{transform:scale(1.06);box-shadow:0 6px 28px rgba(22,101,52,.5);}',
      ...
      '.wq-chat-send{',
        ...
        'border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;',
        'flex-shrink:0;transition:background .18s,transform .12s;',
      '}',
      '.wq-chat-send:hover{background:#14502e;transform:scale(1.04);}',
